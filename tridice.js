...
class DiceFaces {
  ...
  randomMove() {
    const choice = ["up", "down", "left", "right"][DiceFaces.randint(0, 4)];
  ...
  roll() {
    ...
    const leftoverFaceNumbers = [1, 2, 3, 4];
  ...
  setNeighbor(neighborDirection, neighborCell, doReciprocate = true) {
    ...
    if (
      ...
      const inverseDirection =
        DiceFaces.faceDirectionInverter[neighborDirection];
...
class Tridice {
  ...
  constructor() {
    ...
    const neighborhoodKeys = ["up", "down", "left", "right"];
